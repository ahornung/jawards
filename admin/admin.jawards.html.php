...
class HTML_awards {
	...
	function showAwards( &$rows, &$pageNav, $option, &$search, &$lists) {
		...
		<tr>
			...
			<a href="index2.php?option=com_jawards&amp;task=list&amp;sortby=award" title="<?php echo JText::_('AWARDS_ADM_ORDERBY_AWARD'); ?>"><?php echo JText::_('AWARDS_AWARD'); ?></a>
			</th>
			<th align="left" nowrap>
			<a href="index2.php?option=com_jawards&amp;task=list&amp;sortby=user" title="<?php echo JText::_('AWARDS_ADM_ORDERBY_AWARDED_TO'); ?>"><?php echo JText::_('AWARDS_ADM_AWARDED_TO'); ?></a>
			</th>
			<th align="left" nowrap>
			<a href="index2.php?option=com_jawards&amp;task=list&amp;sortby=date" title="<?php echo JText::_('AWARDS_ADM_ORDERBY_DATE'); ?>"><?php echo JText::_('AWARDS_DATE'); ?></a>
			</th>
		</tr>
		<?php
